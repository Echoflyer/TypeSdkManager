                    ...
                    <div class="row">
                            <div class="form-inline text-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSourceGameVersion" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="  select id=0,GameVersion='--全部--' union all select id,(GameVersion+'_'+PageageTable) as GameVersion from [sdk_UploadPackageInfo] where GameID=@GameID and GamePlatFrom='IOS'">
                                        <SelectParameters>
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourcePackage">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%#"<a href=\"http://192.168.1.125:8001/output/ipa/"+Eval("GameNameSpell")+"/"+Eval("CreateTaskID")+"/"+Eval("PackageName")+"\">下载</a>" %>
                                        </td>
                                        <td>
