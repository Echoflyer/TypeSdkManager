                    ...
                    <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <button id="btnEdit" type="button" data-toggle="modal" class="btn btn-primary btn-sm" data-target="#divAddGame" onclick='GetEditInfo(this,"1")'><i class='fa fa-edit'></i> 编辑 </button>
