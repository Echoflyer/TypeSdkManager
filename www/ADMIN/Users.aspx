            ...
            <div class="modal-content">
                ...
                <div style="margin: 20px 0; border: 1px solid #808080;" id="divRolePower">
                    <%--                    <div style="float: left; padding: 20px;">
                        <input type="checkbox" id="cb1" /><label for="cb1" style="margin-left: 5px;">巨龙城堡</label>
                    </div>
                    <div style="float: left; padding: 20px;">
                        <input type="checkbox" id="cb2" /><label for="cb2" style="margin-left: 5px;">无双小师妹</label>
                    </div>
                    <div style="float: left; padding: 20px;">
                        <input type="checkbox" id="cb3" /><label for="cb3" style="margin-left: 5px;">无间狱</label>
                    </div>
                    <div style="float: left; padding: 20px;">
                        <input type="checkbox" id="cb4" /><label for="cb4" style="margin-left: 5px;">超神大陆</label>
                    </div>
